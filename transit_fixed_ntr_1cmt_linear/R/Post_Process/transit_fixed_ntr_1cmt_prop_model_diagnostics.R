...
model <- cmdstan_model(
  "transit_fixed_ntr_1cmt_linear/Stan/Predict/transit_fixed_ntr_1cmt_prop_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/transit_fixed_ntr_1cmt_prop_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/transit_fixed_ntr_1cmt_prop_npde.R for an alternate but 
