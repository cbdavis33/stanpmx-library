...
model <- cmdstan_model(
  "iv_2cmt_linear/Stan/Predict/iv_2cmt_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/iv_2cmt_exp_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_2cmt_exp_npde.R for an alternate but 
