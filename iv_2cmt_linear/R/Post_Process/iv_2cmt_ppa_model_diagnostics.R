...
model <- cmdstan_model(
  "iv_2cmt_linear/Stan/Predict/iv_2cmt_ppa_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/iv_2cmt_ppa_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_2cmt_ppa_npde.R for an alternate but 
