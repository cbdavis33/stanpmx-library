...
fit_analytical$save_object("iv_2cmt_linear/Stan/Fits/iv_2cmt_prop_analytical.rds")
...
fit_mat_exp$save_object("iv_2cmt_linear/Stan/Fits/iv_2cmt_prop_mat_exp.rds")
