  ...
  if(no_gq_predictions == 0){
    ...
    for(j in 1:n_subjects){
      ...
      if(solver == 1){
        ...
        x_epred[subj_start[j]:subj_end[j],] =
          pmx_solve_twocpt(time[subj_start[j]:subj_end[j]],
                           ...
                           addl[subj_start[j]:subj_end[j]],
                           ss[subj_start[j]:subj_end[j]],
                           {CL_new[j], Q_new[j], VC_new[j], VP_new[j], 0})';
        ...
        x_epred[subj_start[j]:subj_end[j],] =
          pmx_solve_rk45(iv_2cmt_ode,
                         ...
                         addl[subj_start[j]:subj_end[j]],
                         ss[subj_start[j]:subj_end[j]],
                         {CL_new[j], VC_new[j], Q_new[j], VP_new[j]}, 
                         bioav, tlag)';
      ...
      dv_epred[subj_start[j]:subj_end[j]] =
        x_epred[subj_start[j]:subj_end[j], (n_cmt - 1)] ./ VC_new[j];
      
      dv_pred[subj_start[j]:subj_end[j]] =
        x_pred[subj_start[j]:subj_end[j], (n_cmt - 1)] ./ vc_p;
