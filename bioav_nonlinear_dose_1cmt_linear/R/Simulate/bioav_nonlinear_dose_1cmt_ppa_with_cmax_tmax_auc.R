...
model <- cmdstan_model(
  "bioav_nonlinear_dose_1cmt_linear/Stan/Simulate/bioav_nonlinear_dose_1cmt_ppa_with_cmax_tmax_auc.stan") 
...
params_ind <- simulated_data$draws(c("CL", "VC", "KA", "BIOAV",
  ...
  inner_join(dosing_data %>%
             ...
             by = "ID") %>%
  ungroup() %>%
  select(ID, CL, VC, KA, BIOAV,auc_t1_t2, c_max, t_max, t_half, DOSE)
...
data %>%
  select(-IPRED) %>%
  write_csv("bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_ppa.csv",
            na = ".")
  # write_csv("bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_prop.csv",
  #           na = ".")

params_ind %>%
  write_csv(
    "bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_ppa_params_ind.csv")
    # "bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_prop_params_ind.csv")
