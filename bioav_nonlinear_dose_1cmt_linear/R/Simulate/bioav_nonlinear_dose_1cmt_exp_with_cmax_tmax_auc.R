...
model <- cmdstan_model(
  "bioav_nonlinear_dose_1cmt_linear/Stan/Simulate/bioav_nonlinear_dose_1cmt_exp_with_cmax_tmax_auc.stan") 
...
data %>%
  select(-IPRED) %>%
  write_csv("bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_exp.csv",
            na = ".")

params_ind %>%
  write_csv(
    "bioav_nonlinear_dose_1cmt_linear/Data/bioav_nonlinear_dose_1cmt_exp_params_ind.csv")
