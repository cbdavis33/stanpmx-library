...
fit <- read_rds("bioav_nonlinear_dose_1cmt_linear/Stan/Fits/bioav_nonlinear_dose_1cmt_prop.rds")
...
model <- cmdstan_model(
  "bioav_nonlinear_dose_1cmt_linear/Stan/Predict/bioav_nonlinear_dose_1cmt_prop_predict_new_subjects.stan")
