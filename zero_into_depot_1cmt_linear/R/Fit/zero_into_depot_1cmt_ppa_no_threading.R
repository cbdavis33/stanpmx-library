...
model <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Fit/zero_into_depot_1cmt_ppa_no_threading.stan")
...
fit$save_object(
  "zero_into_depot_1cmt_linear/Stan/Fits/zero_into_depot_1cmt_ppa_no_threading.rds")
