...
model <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Fit/zero_into_depot_1cmt_prop_no_threading.stan")
...
fit$save_object(
  "zero_into_depot_1cmt_linear/Stan/Fits/zero_into_depot_1cmt_prop_no_threading.rds")

fit$save_data_file(dir = "zero_into_depot_1cmt_linear/Stan/Fits/Stan_Data",
