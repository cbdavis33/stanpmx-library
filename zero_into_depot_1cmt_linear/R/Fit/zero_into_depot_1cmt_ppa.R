...
nonmem_data <- read_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_ppa.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model("zero_into_depot_1cmt_linear/Stan/Fit/zero_into_depot_1cmt_ppa.stan",
...
fit$save_object("zero_into_depot_1cmt_linear/Stan/Fits/zero_into_depot_1cmt_ppa.rds")
