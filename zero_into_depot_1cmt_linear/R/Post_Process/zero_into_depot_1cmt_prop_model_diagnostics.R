...
## Read in fit
fit <- read_rds("zero_into_depot_1cmt_linear/Stan/Fits/zero_into_depot_1cmt_prop.rds")
...
## VPCs. Also see ../VPC/zero_into_depot_1cmt_prop_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/zero_into_depot_1cmt_prop_npde.R for an alternate but 
