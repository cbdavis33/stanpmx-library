...
## Read in fit
fit <- read_rds("zero_into_depot_1cmt_linear/Stan/Fits/zero_into_depot_1cmt_exp.rds")
...
model <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Predict/zero_into_depot_1cmt_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/zero_into_depot_1cmt_exp_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/zero_into_depot_1cmt_exp_npde.R for an alternate but 
