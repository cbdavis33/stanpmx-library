...
filename_base <- "zero_into_depot_1cmt_linear/Stan/Fits"

fit_ppa <- read_rds(file.path(filename_base, "zero_into_depot_1cmt_ppa.rds"))
...
model_prop <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Cross_Validation/zero_into_depot_1cmt_prop_logo_cv_sim.stan")

model_exp <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Cross_Validation/zero_into_depot_1cmt_exp_logo_cv_sim.stan")
