...
model <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Simulate/zero_into_depot_1cmt_exp_with_cmax_tmax_auc.stan") 
...
data %>%
  select(-IPRED) %>%
  write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_exp.csv",
            na = ".")

params_ind %>%
  write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_exp_params_ind.csv",
            na = ".")
