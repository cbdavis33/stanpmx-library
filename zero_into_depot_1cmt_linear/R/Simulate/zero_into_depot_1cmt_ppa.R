...
model <- cmdstan_model(
  "zero_into_depot_1cmt_linear/Stan/Simulate/zero_into_depot_1cmt_ppa.stan") 
...
data %>%
  select(-IPRED) %>%
  write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_prop.csv",
            na = ".")
  # write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_ppa.csv",
  #           na = ".")

params_ind %>%
  write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_prop_params_ind.csv")
  # write_csv("zero_into_depot_1cmt_linear/Data/zero_into_depot_1cmt_ppa_params_ind.csv")
