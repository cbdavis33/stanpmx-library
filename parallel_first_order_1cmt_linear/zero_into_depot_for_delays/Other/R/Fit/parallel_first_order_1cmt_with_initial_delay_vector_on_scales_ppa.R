...
model <- cmdstan_model(
  file.path("parallel_first_order_1cmt_linear",
            ...
            "Stan", 
            "Fit",
            "parallel_first_order_1cmt_with_initial_delay_vector_on_scales_ppa.stan"),
...
fit <- model$sample(
  ...
  refresh = 100,
  max_treedepth = 10,
  output_dir = file.path("parallel_first_order_1cmt_linear",
                         "zero_into_depot_for_delays",
                         "Stan", 
                         "Fits",
                         "Output"),
  output_basename = "with_initial_delay_vector_on_scales_ppa",
...
fit$save_object(
  file.path("parallel_first_order_1cmt_linear",
            ...
            "Stan", 
            "Fits",
            "parallel_first_order_1cmt_with_initial_delay_vector_on_scales_ppa.rds"))
...
fit$save_data_file(dir = file.path("parallel_first_order_1cmt_linear",
                                   ...
                                   "Fits",
                                   "Stan_Data"),
                   basename = "with_initial_delay_vector_on_scales_ppa", 
