...
model <- cmdstan_model(
  file.path("parallel_first_order_1cmt_linear",
            ...
            "Stan",
            "Simulate",
            "parallel_first_order_1cmt_ppa_with_cmax_tmax_auc.stan"))
...
params_ind <- simulated_data$draws(c("CL", "VC", "KA", "DUR", "auc_t1_t2", 
                                     "c_max", "t_max", "t_half")) %>% 
...
if(sigma_a == 0){
  ...
  params_ind %>%
    write_csv(file.path("parallel_first_order_1cmt_linear",
                        ...
                        "Data", 
                        str_c("parallel_", n_depots, "_first_order_",
                              delay_string, "_prop_params_ind.csv")),
              na = ".")
  ...
  params_ind %>%
    write_csv(file.path("parallel_first_order_1cmt_linear",
                        ...
                        "Data", 
                        str_c("parallel_", n_depots, "_first_order_",
                              delay_string, "_ppa_params_ind.csv")),
              na = ".")
