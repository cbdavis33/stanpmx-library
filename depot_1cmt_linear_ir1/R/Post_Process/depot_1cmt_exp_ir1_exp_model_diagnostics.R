...
nonmem_data <- read_csv(
  "depot_1cmt_linear_ir1/Data/depot_1cmt_exp_ir1_exp.csv",
  na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Predict/depot_1cmt_exp_ir1_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_exp_ir1_exp_vpc.R for an alternate but 
...
## NPDEs. Also see ../NPDE/depot_1cmt_exp_ir1_exp_npde.R for an alternate but 
