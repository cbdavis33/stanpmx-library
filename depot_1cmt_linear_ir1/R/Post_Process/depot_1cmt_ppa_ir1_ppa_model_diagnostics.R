...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Predict/depot_1cmt_ppa_ir1_ppa_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_ppa_ir1_ppa_vpc.R for an alternate but 
...
## NPDEs. Also see ../NPDE/depot_1cmt_ppa_ir1_ppa_npde.R for an alternate but 
