...
nonmem_data <- read_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_prop_ir1_prop.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Fit/depot_1cmt_prop_ir1_prop_all_solvers.stan",
...
fit_rk45$save_object("depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop_rk45.rds")
...
fit_adams$save_object(
  "depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop_adams.rds")
...
fit_bdf$save_object(
  "depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop_bdf.rds")
...
fit_rk45_coupled$save_object(
  "depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop_rk45_coupled.rds")
...
fit_bdf_coupled$save_object(
  "depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop_bdf_coupled.rds")
