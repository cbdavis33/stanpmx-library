...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Fit/depot_1cmt_prop_ir1_prop.stan",
...
fit <- model$sample(
  ...
  refresh = 100,
  max_treedepth = 10,
  output_dir = "depot_1cmt_linear_ir1/Stan/Fits/Output",
...
fit$save_object("depot_1cmt_linear_ir1/Stan/Fits/depot_1cmt_prop_ir1_prop.rds")
fit$save_data_file(dir = "depot_1cmt_linear_ir1/Stan/Fits/Stan_Data",
