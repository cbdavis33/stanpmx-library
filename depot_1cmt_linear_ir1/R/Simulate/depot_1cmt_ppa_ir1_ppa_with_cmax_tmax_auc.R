...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Simulate/depot_1cmt_ppa_ir1_ppa_with_cmax_tmax_auc.stan")
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_ppa_ir1_ppa.csv", na = ".")
  # write_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_prop_ir1_prop.csv", na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_ppa_ir1_ppa_params_ind.csv")
  # write_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_prop_ir1_prop_params_ind.csv")
