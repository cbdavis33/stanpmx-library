...
model <- cmdstan_model(
  "depot_1cmt_linear_ir1/Stan/Predict/depot_1cmt_prop_ir1_prop_predict_new_subjects.stan")
...
data <- read_csv("depot_1cmt_linear_ir1/Data/depot_1cmt_prop_ir1_prop.csv", 
                 na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
