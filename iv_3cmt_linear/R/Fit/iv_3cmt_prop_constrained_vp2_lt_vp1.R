...
model <- cmdstan_model(
  "iv_3cmt_linear/Stan/Fit/iv_3cmt_prop_constrained_vp2_lt_vp1.stan",
...
fit <- model$sample(
  ...
  output_basename = "prop_constrained_vp2_lt_vp1",
  init = function()
    with(stan_data,
...
fit$save_object("iv_3cmt_linear/Stan/Fits/iv_3cmt_prop_constrained_vp2_lt_vp1.rds")

fit$save_data_file(dir = "iv_3cmt_linear/Stan/Fits/Stan_Data",
                   basename = "prop_constrained_vp2_lt_vp1", timestamp = FALSE, random = FALSE)
