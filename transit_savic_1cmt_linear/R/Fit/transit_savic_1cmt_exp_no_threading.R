...
model <- cmdstan_model(
  "transit_savic_1cmt_linear/Stan/Fit/transit_savic_1cmt_exp_no_threading.stan")
...
fit$save_object(
  "transit_savic_1cmt_linear/Stan/Fits/transit_savic_1cmt_exp_no_threading.rds")
