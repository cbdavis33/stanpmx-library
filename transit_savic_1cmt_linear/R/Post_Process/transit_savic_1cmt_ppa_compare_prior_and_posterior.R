...
stan_data <- jsonlite::read_json(
  "transit_savic_1cmt_linear/Stan/Fits/Stan_Data/ppa.json") %>% 
...
parameters_to_summarize <- c(str_c("TV", c("CL", "VC", "KA", "NTR", "MTT")),
...
(target_comparison_cor <- draws_all_df %>% 
    filter(variable %in% c("cor_cl_vc", "cor_cl_ka", "cor_cl_ntr", "cor_cl_mtt",
                           "cor_vc_ka", "cor_vc_ntr", "cor_vc_mtt",
                           "cor_ka_ntr", "cor_ka_mtt",
                           "cor_ntr_mtt")) %>% 
    mutate(variable = 
             factor(variable, 
                    levels = c("cor_cl_vc", "cor_cl_ka", "cor_cl_ntr", "cor_cl_mtt",
                               "cor_vc_ka", "cor_vc_ntr", "cor_vc_mtt",
                               "cor_ka_ntr", "cor_ka_mtt",
                               "cor_ntr_mtt")),
