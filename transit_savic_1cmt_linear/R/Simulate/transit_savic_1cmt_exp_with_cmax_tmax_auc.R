...
model <- cmdstan_model(
  "transit_savic_1cmt_linear/Stan/Simulate/transit_savic_1cmt_exp_with_cmax_tmax_auc.stan") 
...
data %>%
  select(-IPRED) %>%
  write_csv("transit_savic_1cmt_linear/Data/transit_savic_1cmt_exp.csv", na = ".")

params_ind %>%
  write_csv("transit_savic_1cmt_linear/Data/transit_savic_1cmt_exp_params_ind.csv")
