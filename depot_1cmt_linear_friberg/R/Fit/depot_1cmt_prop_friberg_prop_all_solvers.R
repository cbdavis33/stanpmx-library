...
nonmem_data <- read_csv("depot_1cmt_linear_friberg/Data/depot_1cmt_prop_friberg_prop.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "depot_1cmt_linear_friberg/Stan/Fit/depot_1cmt_prop_friberg_prop_all_solvers.stan",
...
# 
# fit_rk45$save_object("depot_1cmt_linear_friberg/Stan/Fits/depot_1cmt_prop_friberg_prop_rk45.rds")
# 
# 
# stan_data$solver <- 2
...
#   "depot_1cmt_linear_friberg/Stan/Fits/depot_1cmt_prop_friberg_prop_rk45_coupled.rds")
# 
# 
# stan_data$solver <- 3
...
# 
# fit_bdf$save_object(
#   "depot_1cmt_linear_friberg/Stan/Fits/depot_1cmt_prop_friberg_prop_bdf.rds")
...
fit_bdf_coupled$save_object(
  "depot_1cmt_linear_friberg/Stan/Fits/depot_1cmt_prop_friberg_prop_bdf_coupled.rds")
