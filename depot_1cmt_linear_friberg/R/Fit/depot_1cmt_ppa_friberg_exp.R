...
nonmem_data <- read_csv("depot_1cmt_linear_friberg/Data/depot_1cmt_ppa_friberg_exp.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
fit$save_object("depot_1cmt_linear_friberg/Stan/Fits/depot_1cmt_ppa_friberg_exp.rds")
