...
model <- cmdstan_model(
  "depot_1cmt_linear_friberg/Stan/Simulate/depot_1cmt_ppa_friberg_exp_with_cmax_tmax_auc.stan") 
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_friberg/Data/depot_1cmt_ppa_friberg_exp.csv", na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_friberg/Data/depot_1cmt_ppa_friberg_exp_params_ind.csv")
