...
fit_analytical$save_object("iv_1cmt_linear/Stan/Fits/iv_1cmt_prop_analytical.rds")
...
fit_mat_exp$save_object("iv_1cmt_linear/Stan/Fits/iv_1cmt_prop_mat_exp.rds")
...
fit_rk45$save_object("iv_1cmt_linear/Stan/Fits/iv_1cmt_prop_rk45.rds")
