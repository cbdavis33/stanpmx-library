...
model <- cmdstan_model(
  "iv_1cmt_linear/Stan/Predict/iv_1cmt_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/iv_1cmt_exp_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_1cmt_exp_npde.R for an alternate but 
