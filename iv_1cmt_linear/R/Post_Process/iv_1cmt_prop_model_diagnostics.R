...
model <- cmdstan_model(
  "iv_1cmt_linear/Stan/Predict/iv_1cmt_prop_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/iv_1cmt_prop_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_1cmt_prop_npde.R for an alternate but 
