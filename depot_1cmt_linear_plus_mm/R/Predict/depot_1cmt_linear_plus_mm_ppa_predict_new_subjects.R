...
nonmem_data <- read_csv(
  "depot_1cmt_linear_plus_mm/Data/depot_1cmt_linear_plus_mm_ppa.csv",
  na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "depot_1cmt_linear_plus_mm/Stan/Predict/depot_1cmt_linear_plus_mm_ppa_predict_new_subjects.stan")
