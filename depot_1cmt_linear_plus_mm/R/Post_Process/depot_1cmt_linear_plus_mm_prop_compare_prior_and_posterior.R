...
model <- cmdstan_model(
  "depot_1cmt_linear_plus_mm/Stan/Fit/depot_1cmt_linear_plus_mm_prop.stan",
...
fit <- read_rds("depot_1cmt_linear_plus_mm/Stan/Fits/depot_1cmt_linear_plus_mm_prop.rds")
