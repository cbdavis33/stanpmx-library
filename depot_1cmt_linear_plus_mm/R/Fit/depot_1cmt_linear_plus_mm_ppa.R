...
nonmem_data <- read_csv("depot_1cmt_linear_plus_mm/Data/depot_1cmt_linear_plus_mm_ppa.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "depot_1cmt_linear_plus_mm/Stan/Fit/depot_1cmt_linear_plus_mm_ppa.stan",
...
fit$save_object("depot_1cmt_linear_plus_mm/Stan/Fits/depot_1cmt_linear_plus_mm_ppa.rds")
