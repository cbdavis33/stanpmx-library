...
generated quantities{
 ...
 
  {
    ...
    vector[n_random] typical_values = to_vector({TVCL, TVVC, TVVMAX, TVKM, TVKA});
    ...
    for(m in 1:n_sim){
      ...
      for(j in 1:n_subjects){
        ...
        real VMAX_new = theta_new[3]; 
        real KM_new = theta_new[4];
        ...
        x_epred[subj_start[j]:subj_end[j],] =
          pmx_solve_rk45(depot_1cmt_linear_plus_mm_ode,
                         ...
                         {CL_new, VC_new, VMAX_new, KM_new, KA_new}, 
                         bioav, tlag)';
