...
model <- cmdstan_model("depot_1cmt_linear_t/Stan/Simulate/depot_1cmt_exp_t.stan") 
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_t/Data/depot_1cmt_exp_t.csv", na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_t/Data/depot_1cmt_exp_t_params_ind.csv")
