...
model <- cmdstan_model(
  "depot_1cmt_linear_t/Stan/Predict/depot_1cmt_prop_t_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_prop_t_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/depot_1cmt_prop_t_npde.R for an alternate but 
