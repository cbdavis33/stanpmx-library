...
generated quantities{
 ...
 
  {
    ...
    vector[n_random] typical_values = to_vector({TVCL, TVVC, TVKA, TVBIOAV});
    ...
    for(m in 1:n_sim){
      ...
      for(j in 1:n_subjects){
        ...
        real BIOAV_new = Phi(inv_Phi(TVBIOAV) + eta_new[4]); // Phi(inv_Phi(TVBIOAV) + covariate_effects + eta_new[j, 4]);
