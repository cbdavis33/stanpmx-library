...
## Read in fit
fit <- read_rds("bioav_iv_and_oral_1cmt_linear/Stan/Fits/bioav_iv_and_oral_1cmt_prop.rds")
...
model <- cmdstan_model(
  "bioav_iv_and_oral_1cmt_linear/Stan/Predict/bioav_iv_and_oral_1cmt_prop_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/bioav_iv_and_oral_1cmt_prop_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/bioav_iv_and_oral_1cmt_prop_npde.R for an alternate but 
