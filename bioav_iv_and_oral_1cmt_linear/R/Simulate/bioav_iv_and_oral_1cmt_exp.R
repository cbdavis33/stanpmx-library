...
model <- cmdstan_model(
  "bioav_iv_and_oral_1cmt_linear/Stan/Simulate/bioav_iv_and_oral_1cmt_exp.stan") 
...
params_ind %>%
  write_csv(
    "bioav_iv_and_oral_1cmt_linear/Data/bioav_iv_and_oral_1cmt_exp_params_ind.csv")
