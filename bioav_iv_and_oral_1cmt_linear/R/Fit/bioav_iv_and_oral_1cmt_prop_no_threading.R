...
model <- cmdstan_model(
  "bioav_iv_and_oral_1cmt_linear/Stan/Fit/bioav_iv_and_oral_1cmt_prop_no_threading.stan")
...
# fit$save_object(
#   "bioav_iv_and_oral_1cmt_linear/Stan/Fits/bioav_iv_and_oral_1cmt_prop_no_threading.rds")
