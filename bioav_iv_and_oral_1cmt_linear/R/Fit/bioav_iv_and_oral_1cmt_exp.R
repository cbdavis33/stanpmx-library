...
nonmem_data <- read_csv("bioav_iv_and_oral_1cmt_linear/Data/bioav_iv_and_oral_1cmt_exp.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
fit$save_object("bioav_iv_and_oral_1cmt_linear/Stan/Fits/bioav_iv_and_oral_1cmt_exp.rds")
