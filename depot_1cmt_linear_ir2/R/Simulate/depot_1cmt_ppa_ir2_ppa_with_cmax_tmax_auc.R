...
model <- cmdstan_model(
  "depot_1cmt_linear_ir2/Stan/Simulate/depot_1cmt_ppa_ir2_ppa_with_cmax_tmax_auc.stan")
...
data %>%
  select(-IPRED) %>%
  write_csv(str_c("depot_1cmt_linear_ir2/Data/depot_1cmt_", prop_or_ppa_pk,
                  "_ir2_", prop_or_ppa_pd, ".csv"),
            na = ".")

params_ind %>%
  write_csv(str_c("depot_1cmt_linear_ir2/Data/depot_1cmt_", prop_or_ppa_pk,
                  "_ir2_", prop_or_ppa_pd, "_params_ind.csv"),
            na = ".")
