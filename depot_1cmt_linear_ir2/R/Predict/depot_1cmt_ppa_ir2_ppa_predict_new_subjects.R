...
model <- cmdstan_model(
  "depot_1cmt_linear_ir2/Stan/Predict/depot_1cmt_ppa_ir2_ppa_predict_new_subjects.stan")
...
data <- read_csv("depot_1cmt_linear_ir2/Data/depot_1cmt_ppa_ir2_ppa.csv", 
                 na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
