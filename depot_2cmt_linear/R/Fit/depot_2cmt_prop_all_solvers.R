...
model <- cmdstan_model(
  "depot_2cmt_linear/Stan/Fit/depot_2cmt_prop_all_solvers.stan",
...
fit_analytical$save_object("depot_2cmt_linear/Stan/Fits/depot_2cmt_prop_analytical.rds")
...
fit_mat_exp$save_object("depot_2cmt_linear/Stan/Fits/depot_2cmt_prop_mat_exp.rds")
...
fit_rk45$save_object("depot_2cmt_linear/Stan/Fits/depot_2cmt_prop_rk45.rds")
...
fit_bdf$save_object("depot_2cmt_linear/Stan/Fits/depot_2cmt_prop_bdf.rds")
