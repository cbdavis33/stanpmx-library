...
filename_base <- "depot_2cmt_linear/Stan/Fits"

fit_ppa <- read_rds(file.path(filename_base, "depot_2cmt_ppa.rds"))
...
model_prop <- cmdstan_model(
  "depot_2cmt_linear/Stan/Cross_Validation/depot_2cmt_prop_logo_cv_sim.stan")

model_exp <- cmdstan_model(
  "depot_2cmt_linear/Stan/Cross_Validation/depot_2cmt_exp_logo_cv_sim.stan")
