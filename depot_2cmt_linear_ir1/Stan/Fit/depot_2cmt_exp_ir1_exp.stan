...
functions{
  ...
  real partial_sum_lpmf(array[] int seq_subj, int start, int end,
    ...
    //     
    //     if(bloq_slice[i] == 1){
    //       ptarget += lognormal_lcdf(lloq_slice[i] | log_ipred_tmp, sigma); 
    //     }else{
    //       ptarget += lognormal_lpdf(dv_obs_slice[i] | log_ipred_tmp, sigma);
    //     }
    //     
    //   }else if(cmt_slice[i] == 4){
    //     
    //     if(bloq_slice[i] == 1){
    //       ptarget += lognormal_lcdf(lloq_slice[i] | log_ipred_tmp, sigma_pd); 
    //     }else{
    //       ptarget += lognormal_lpdf(dv_obs_slice[i] | log_ipred_tmp, sigma_pd);
    //     }
    //     
    //   }
    // }                                         
