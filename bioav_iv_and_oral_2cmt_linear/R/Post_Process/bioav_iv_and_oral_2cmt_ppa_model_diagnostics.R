...
model <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Predict/bioav_iv_and_oral_2cmt_ppa_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/bioav_iv_and_oral_2cmt_ppa_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/bioav_iv_and_oral_2cmt_ppa_npde.R for an alternate but 
