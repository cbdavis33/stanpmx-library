...
filename_base <- "bioav_iv_and_oral_2cmt_linear/Stan/Fits"

fit_ppa <- read_rds(file.path(filename_base, "bioav_iv_and_oral_2cmt_ppa.rds"))
...
model_ppa <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Cross_Validation/bioav_iv_and_oral_2cmt_ppa_logo_cv_sim.stan")

model_prop <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Cross_Validation/bioav_iv_and_oral_2cmt_prop_logo_cv_sim.stan")

model_exp <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Cross_Validation/bioav_iv_and_oral_2cmt_exp_logo_cv_sim.stan")
