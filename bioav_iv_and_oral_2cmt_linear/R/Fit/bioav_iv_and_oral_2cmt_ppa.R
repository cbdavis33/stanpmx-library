...
nonmem_data <- read_csv("bioav_iv_and_oral_2cmt_linear/Data/bioav_iv_and_oral_2cmt_ppa.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
fit$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/bioav_iv_and_oral_2cmt_ppa.rds")
