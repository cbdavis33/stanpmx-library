...
nonmem_data <- read_csv("bioav_iv_and_oral_2cmt_linear/Data/bioav_iv_and_oral_2cmt_exp.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model("bioav_iv_and_oral_2cmt_linear/Stan/Fit/bioav_iv_and_oral_2cmt_exp.stan",
...
fit$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/bioav_iv_and_oral_2cmt_exp.rds")
