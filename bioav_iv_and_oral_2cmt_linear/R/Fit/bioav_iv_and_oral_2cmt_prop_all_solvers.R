...
model <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Fit/bioav_iv_and_oral_2cmt_prop_all_solvers.stan",
...
fit_analytical$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/prop_analytical.rds")
...
fit_mat_exp$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/prop_mat_exp.rds")
...
fit_rk45$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/prop_rk45.rds")
