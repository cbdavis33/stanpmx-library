...
model <- cmdstan_model("bioav_iv_and_oral_2cmt_linear/Stan/Fit/bioav_iv_and_oral_2cmt_prop.stan",
...
fit$save_object("bioav_iv_and_oral_2cmt_linear/Stan/Fits/bioav_iv_and_oral_2cmt_prop.rds")
