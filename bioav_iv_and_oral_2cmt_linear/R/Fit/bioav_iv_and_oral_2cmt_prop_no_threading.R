...
nonmem_data <- read_csv("bioav_iv_and_oral_2cmt_linear/Data/bioav_iv_and_oral_2cmt_prop.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
model <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Fit/bioav_iv_and_oral_2cmt_prop_no_threading.stan")
...
fit <- model$sample(data = stan_data,
                    ...
                    refresh = 500,
                    max_treedepth = 10,
                    # output_dir = "bioav_iv_and_oral_2cmt_linear/Stan/Fits/Output",
...
# fit$save_object(
#   "bioav_iv_and_oral_2cmt_linear/Stan/Fits/bioav_iv_and_oral_2cmt_prop_no_threading.rds")

# fit$save_data_file(dir = "bioav_iv_and_oral_2cmt_linear/Stan/Fits/Stan_Data",
#                    basename = "prop_no_threading", timestamp = FALSE, random = FALSE)
