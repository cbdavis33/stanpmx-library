...
model <- cmdstan_model(
  "bioav_iv_and_oral_2cmt_linear/Stan/Simulate/bioav_iv_and_oral_2cmt_ppa_with_cmax_tmax_auc.stan") 
...
data %>%
  select(-IPRED) %>%
  write_csv(str_c("bioav_iv_and_oral_2cmt_linear/Data/bioav_iv_and_oral_2cmt_",
                  prop_or_ppa, ".csv"),
            na = ".")
