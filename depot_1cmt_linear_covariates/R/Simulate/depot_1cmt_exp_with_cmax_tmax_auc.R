...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates/Stan/Simulate/depot_1cmt_exp_with_cmax_tmax_auc_covariates.stan") 
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_covariates/Data/depot_1cmt_exp_covariates.csv", 
            na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_covariates/Data/depot_1cmt_exp_params_ind_covariates.csv")
