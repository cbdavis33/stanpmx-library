...
#   1) Use the _predict_new_subjects_covariates_fixed_allometric.stan file to simulate new 
#        datasets with the same design. 
...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates/Stan/Predict/depot_1cmt_prop_predict_new_subjects_covariates_fixed_allometric.stan")
