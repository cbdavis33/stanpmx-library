...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates/Stan/Predict/depot_1cmt_ppa_predict_observed_subjects_covariates.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_ppa_vpc_covariates.R for an alternate but 
...
## NPDEs. Also see ../NPDE/depot_1cmt_ppa_npde_covariates.R for an alternate 
