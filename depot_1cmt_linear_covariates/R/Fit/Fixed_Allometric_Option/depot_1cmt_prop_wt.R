...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates/Stan/Fit/Fixed_Allometric_Option/depot_1cmt_prop_wt_allometric_option.stan",
...
fit$save_object(
  "depot_1cmt_linear_covariates/Stan/Fits/depot_1cmt_prop_wt_fixed_allometric.rds")

stan_data$fixed_allometric <- 0
fit <- model$sample(data = stan_data,
                    seed = 11235,
                    chains = 4,
                    parallel_chains = 4,
...
fit$save_object(
  "depot_1cmt_linear_covariates/Stan/Fits/depot_1cmt_prop_wt.rds")
