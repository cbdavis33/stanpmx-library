...
fit_analytical$save_object("depot_1cmt_linear/Stan/Fits/depot_1cmt_prop_analytical.rds")
...
fit_mat_exp$save_object("depot_1cmt_linear/Stan/Fits/depot_1cmt_prop_mat_exp.rds")
...
fit_rk45$save_object("depot_1cmt_linear/Stan/Fits/depot_1cmt_prop_rk45.rds")
...
fit_bdf$save_object("depot_1cmt_linear/Stan/Fits/depot_1cmt_prop_bdf.rds")
