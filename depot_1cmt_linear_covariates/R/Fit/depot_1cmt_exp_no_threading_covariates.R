...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates/Stan/Fit/depot_1cmt_exp_no_threading_covariates.stan")
...
fit$save_object(
  "depot_1cmt_linear_covariates/Stan/Fits/depot_1cmt_exp_no_threading_covariates.rds")