...
fit <- read_rds(
  "depot_1cmt_linear_covariates/Stan/Fits/Fixed_Allometric_Option/depot_1cmt_prop_covariates_fixed_allometric.rds")
...
model <- cmdstan_model(
  str_c("depot_1cmt_linear_covariates/Stan/Predict/Fixed_Allometric_Option/",
  "depot_1cmt_prop_predict_observed_subjects_covariates_allometric_option.stan"))
