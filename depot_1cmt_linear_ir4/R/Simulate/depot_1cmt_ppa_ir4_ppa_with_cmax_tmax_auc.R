...
model <- cmdstan_model(
  "depot_1cmt_linear_ir4/Stan/Simulate/depot_1cmt_ppa_ir4_ppa_with_cmax_tmax_auc.stan")
...
params_ind <- simulated_data$draws(c("CL", "VC", "KA",
                                     ...
                                     "t_half", "r_min", "t_min_pd")) %>% 
  spread_draws(c(CL, VC, KA, KIN, KOUT, SC50, SMAX,
                 auc_t1_t2, c_max, t_max,
                 t_half, r_min, t_min_pd)[i]) %>% 
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_ir4/Data/depot_1cmt_ppa_ir4_ppa.csv", na = ".")
  # write_csv("depot_1cmt_linear_ir4/Data/depot_1cmt_prop_ir4_prop.csv", na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_ir4/Data/depot_1cmt_ppa_ir4_ppa_params_ind.csv")
  # write_csv("depot_1cmt_linear_ir4/Data/depot_1cmt_prop_ir4_prop_params_ind.csv")
