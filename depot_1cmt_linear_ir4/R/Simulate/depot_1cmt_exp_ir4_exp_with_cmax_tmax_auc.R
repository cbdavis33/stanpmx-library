...
model <- cmdstan_model(
  "depot_1cmt_linear_ir4/Stan/Simulate/depot_1cmt_exp_ir4_exp_with_cmax_tmax_auc.stan")
...
data %>%
  select(-IPRED) %>%
  write_csv(str_c("depot_1cmt_linear_ir4/Data/depot_1cmt_exp_ir4_exp.csv"),
            na = ".")

params_ind %>%
  write_csv(str_c("depot_1cmt_linear_ir4/Data/depot_1cmt_exp_ir4_exp_params_ind.csv"),
            na = ".")