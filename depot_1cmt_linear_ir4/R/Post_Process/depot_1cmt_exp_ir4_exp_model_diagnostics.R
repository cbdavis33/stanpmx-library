...
model <- cmdstan_model(
  "depot_1cmt_linear_ir4/Stan/Predict/depot_1cmt_exp_ir4_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_exp_ir4_exp_vpc.R for an alternate but 
...
## NPDEs. Also see ../NPDE/depot_1cmt_exp_ir4_exp_npde.R for an alternate but 
