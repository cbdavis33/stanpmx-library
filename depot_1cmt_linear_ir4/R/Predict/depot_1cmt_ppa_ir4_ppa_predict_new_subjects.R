...
model <- cmdstan_model(
  "depot_1cmt_linear_ir4/Stan/Predict/depot_1cmt_ppa_ir4_ppa_predict_new_subjects.stan")
...
data <- read_csv("depot_1cmt_linear_ir4/Data/depot_1cmt_ppa_ir4_ppa.csv", 
                 na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
