 ...
 
  {
    ...
    for(m in 1:n_sim){
      ...
      for(j in 1:n_subjects){
        ...
        K_epred[(n_transit + 3), (n_transit + 3)] = -((CL_new + Q_new)/VC_new);
        K_epred[(n_transit + 3), (n_transit + 4)] = Q_new/VP_new;
        K_epred[(n_transit + 4), (n_transit + 3)] = Q_new/VC_new;
        K_epred[(n_transit + 4), (n_transit + 4)] = -Q_new/VP_new;
