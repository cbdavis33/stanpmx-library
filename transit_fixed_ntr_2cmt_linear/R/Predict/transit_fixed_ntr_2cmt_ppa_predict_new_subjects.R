...
fit <- read_rds("transit_fixed_ntr_2cmt_linear/Stan/Fits/transit_fixed_ntr_2cmt_ppa.rds")
...
nonmem_data <- read_csv("transit_fixed_ntr_2cmt_linear/Data/transit_fixed_ntr_2cmt_ppa.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
