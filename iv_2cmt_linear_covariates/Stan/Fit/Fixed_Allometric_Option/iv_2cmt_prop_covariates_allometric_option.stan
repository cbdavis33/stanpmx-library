...
// Option for fixed allometric scaling coefficients at 0.75 for CL and 1 for VC
...
data{
  ...
  int<lower = 0, upper = 1> fixed_allometric; // Fixed allometric scaling factors?
...
transformed data{ 
  ...
  int n_cmt = 2;       // Number of states in the ODEs (central, peripheral)
...
transformed parameters{
...

  {
    ...
    for(j in 1:n_subjects){
      ...
      real wt_adjustment_cl = (fixed_allometric == 1) ? wt_over_70^0.75 : wt_over_70^theta_cl_wt;
      real wt_adjustment_vc = (fixed_allometric == 1) ? wt_over_70 : wt_over_70^theta_vc_wt;
      real wt_adjustment_q = (fixed_allometric == 1) ? wt_over_70^0.75 : wt_over_70^theta_cl_wt;
      real wt_adjustment_vp = (fixed_allometric == 1) ? wt_over_70 : wt_over_70^theta_vc_wt;
