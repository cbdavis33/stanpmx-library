                      ...
                      init = function() 
                        with(stan_data,
                             list(TVCL = rlnorm(1, log(location_tvcl), scale_tvcl),
                                  ...
                                  TVQ = rlnorm(1, log(location_tvq), scale_tvq),
                                  TVVP = rlnorm(1, log(location_tvvp), scale_tvvp),
                                  theta_cl_wt = rnorm(1, 0, 1),
                                  theta_vc_wt = rnorm(1, 0, 1),
                                  theta_q_wt = rnorm(1, 0, 1),
                                  theta_vp_wt = rnorm(1, 0, 1),
                                  theta_vc_sex = rnorm(1, 0, 1),
                                  theta_cl_egfr = rnorm(1, 0, 1),
                                  theta_vc_race2 = rnorm(1, 0, 1),
                                  theta_vc_race3 = rnorm(1, 0, 1),
                                  theta_vc_race4 = rnorm(1, 0, 1),
