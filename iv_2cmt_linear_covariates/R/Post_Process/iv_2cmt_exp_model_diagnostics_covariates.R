...
model <- cmdstan_model(
  "iv_2cmt_linear_covariates/Stan/Predict/iv_2cmt_exp_predict_observed_subjects_covariates.stan")
...
## VPCs. Also see ../VPC/iv_2cmt_exp_vpc_covariates.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_2cmt_exp_npde_covariates.R for an alternate but 
