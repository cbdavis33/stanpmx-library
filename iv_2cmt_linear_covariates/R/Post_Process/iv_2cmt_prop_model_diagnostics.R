...
## Read in fit
fit <- read_rds("iv_2cmt_linear_covariates/Stan/Fits/iv_2cmt_prop.rds")
...
model <- cmdstan_model(
  "iv_2cmt_linear/Stan/Predict/iv_2cmt_prop_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/iv_2cmt_prop_vpc_covariates.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/iv_2cmt_prop_npde_covariates.R for an alternate but 
