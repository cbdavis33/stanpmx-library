...
filename_base <- "iv_2cmt_linear_covariates/Stan/Fits"

fit_prop <- read_rds(file.path(filename_base, "iv_2cmt_prop.rds"))
fit_prop_covariates <- read_rds(file.path(filename_base, 
                                          "iv_2cmt_prop_covariates.rds"))
fit_prop_covariates_fixed_allometric <- 
  read_rds(file.path(filename_base, "iv_2cmt_prop_covariates_fixed_allometric.rds"))
...
stan_data <- jsonlite::read_json(
  "iv_2cmt_linear_covariates/Stan/Fits/Stan_Data/prop.json") %>% 
...
model_prop <- cmdstan_model(
  "iv_2cmt_linear/Stan/Cross_Validation/iv_2cmt_prop_logo_cv_sim.stan")
...
model_prop_covariates_fixed_allometric <- cmdstan_model(
  "iv_2cmt_linear_covariates/Stan/Cross_Validation/iv_2cmt_prop_logo_cv_sim_covariates_fixed_allometric.stan")
