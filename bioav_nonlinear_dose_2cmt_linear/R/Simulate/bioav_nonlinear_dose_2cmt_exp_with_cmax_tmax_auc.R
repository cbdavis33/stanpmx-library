...
model <- cmdstan_model(
  "bioav_nonlinear_dose_2cmt_linear/Stan/Simulate/bioav_nonlinear_dose_2cmt_exp_with_cmax_tmax_auc.stan") 
...
params_ind <- simulated_data$draws(c("CL", "VC", "Q", "VP", "KA", "BIOAV",
  ...
  select(ID, CL, VC, Q, VP, KA, auc_t1_t2, c_max, t_max,
         t_half_alpha, t_half_terminal, DOSE)
...
data %>%
  ...
  write_csv(file.path("bioav_nonlinear_dose_2cmt_linear",
                      "Data", 
                      "bioav_nonlinear_dose_2cmt_exp.csv"),
            na = ".")
...
params_ind %>%
  write_csv(file.path("bioav_nonlinear_dose_2cmt_linear",
                      "Data", 
                      "bioav_nonlinear_dose_2cmt_exp_params_ind.csv"),
            na = ".")
