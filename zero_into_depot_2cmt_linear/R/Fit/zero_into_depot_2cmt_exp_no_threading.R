...
model <- cmdstan_model(
  "zero_into_depot_2cmt_linear/Stan/Fit/zero_into_depot_2cmt_exp_no_threading.stan")
...
fit$save_object(
  "zero_into_depot_2cmt_linear/Stan/Fits/zero_into_depot_2cmt_exp_no_threading.rds")
