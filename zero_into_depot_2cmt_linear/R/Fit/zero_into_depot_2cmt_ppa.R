...
model <- cmdstan_model("zero_into_depot_2cmt_linear/Stan/Fit/zero_into_depot_2cmt_ppa.stan",
...
fit$save_object("zero_into_depot_2cmt_linear/Stan/Fits/zero_into_depot_2cmt_ppa.rds")
