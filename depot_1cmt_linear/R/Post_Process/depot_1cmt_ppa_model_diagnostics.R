...
model <- cmdstan_model(
  "depot_1cmt_linear/Stan/Predict/depot_1cmt_ppa_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_ppa_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/depot_1cmt_ppa_npde.R for an alternate but 
