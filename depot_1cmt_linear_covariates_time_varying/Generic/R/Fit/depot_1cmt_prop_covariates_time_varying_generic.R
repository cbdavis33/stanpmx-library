...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates_time_varying/Generic/Stan/Fit/depot_1cmt_prop_covariates_time_varying_generic.stan",
  cpp_options = list(stan_threads = TRUE))

basename <- if_else(isTRUE(locf), "prop_locf", "prop_nocb")
...
fit$save_object(
  str_c("depot_1cmt_linear_covariates_time_varying/Generic/Stan/Fits/", 
        basename, 
        ".rds"))
