...
model <- cmdstan_model(
  "depot_1cmt_linear_covariates_time_varying/Generic/Stan/Fit/depot_1cmt_ppa_covariates_time_varying_generic.stan",
  cpp_options = list(stan_threads = TRUE))

basename <- if_else(isTRUE(locf), "ppa_locf", "ppa_nocb")
