...
## Read in fit
fit <- read_rds("iv_2cmt_linear_covariates_time_varying/wt_on_cl/Stan/Fits/andras.rds")
...
mcmc_combo(fit$draws(c("theta_cl_wt")),
           combo = c("dens_overlay", "trace"))
...
mcmc_rank_hist(fit$draws(c("theta_cl_wt")))
