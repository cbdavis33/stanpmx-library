...
file_path <- if_else(isTRUE(locf), 
                     "iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_covariates_time_varying_generic_locf.csv",
                     "iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_covariates_time_varying_generic_nocb.csv")


fit <- if(isTRUE(locf)){
  read_rds("iv_2cmt_linear_covariates_time_varying/Generic/Stan/Fits/exp_locf.rds")
}else{
  read_rds("iv_2cmt_linear_covariates_time_varying/Generic/Stan/Fits/exp_nocb.rds")
}
...
model <- cmdstan_model(
  "iv_2cmt_linear_covariates_time_varying/Generic/Stan/Predict/iv_2cmt_exp_predict_new_subjects_covariates_time_varying.stan")
