...
model <- cmdstan_model(
  "iv_2cmt_linear_covariates_time_varying/Generic/Stan/Simulate/iv_2cmt_exp_covariates_time_varying.stan") 
...
data %>%
  select(-IPRED) %>% 
  # write_csv("iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_covariates_time_varying_generic_nocb.csv",
  #           na = ".")
  write_csv("iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_covariates_time_varying_generic_locf.csv",
            na = ".")

params_ind %>%
  # write_csv("iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_params_ind_covariates_time_varying_generic_nocb.csv")
  write_csv("iv_2cmt_linear_covariates_time_varying/Generic/Data/iv_2cmt_exp_params_ind_covariates_time_varying_generic_locf.csv")
