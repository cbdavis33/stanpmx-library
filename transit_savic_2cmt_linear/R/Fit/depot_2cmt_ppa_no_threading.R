...
model <- cmdstan_model("depot_2cmt_linear/Stan/Fit/depot_2cmt_ppa_no_threading.stan")
...
fit$save_object("depot_2cmt_linear/Stan/Fits/depot_2cmt_ppa_no_threading.rds")
