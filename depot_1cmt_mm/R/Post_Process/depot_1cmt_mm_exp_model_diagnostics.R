...
model <- cmdstan_model(
  "depot_1cmt_mm/Stan/Predict/depot_1cmt_mm_exp_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_mm_exp_vpc.R for an alternate but equivalent
## way to do VPCs
...
## NPDEs. Also see ../NPDE/depot_1cmt_mm_exp_npde.R for an alternate but 
