...
filename_base <- "depot_1cmt_mm/Stan/Fits"

fit_ppa <- read_rds(file.path(filename_base, "depot_1cmt_mm_ppa.rds"))
...
model_prop <- cmdstan_model(
  "depot_1cmt_mm/Stan/Cross_Validation/depot_1cmt_mm_prop_logo_cv_sim.stan")

model_exp <- cmdstan_model(
  "depot_1cmt_mm/Stan/Cross_Validation/depot_1cmt_mm_exp_logo_cv_sim.stan")
