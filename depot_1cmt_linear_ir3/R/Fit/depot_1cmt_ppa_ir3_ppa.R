...
fit <- model$sample(
  ...
  refresh = 100,
  max_treedepth = 10,
  output_dir = "depot_1cmt_linear_ir3/Stan/Fits/Output",
...
fit$save_object("depot_1cmt_linear_ir3/Stan/Fits/depot_1cmt_ppa_ir3_ppa.rds")
fit$save_data_file(dir = "depot_1cmt_linear_ir3/Stan/Fits/Stan_Data",
