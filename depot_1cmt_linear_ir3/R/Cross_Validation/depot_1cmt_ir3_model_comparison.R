...
filename_base <- "depot_1cmt_linear_ir3/Stan/Fits"

fit_ppa <- read_rds(file.path(filename_base, "depot_1cmt_ppa_ir3_ppa.rds"))
...
model_ppa <- cmdstan_model(
  "depot_1cmt_linear_ir3/Stan/Cross_Validation/depot_1cmt_ppa_ir3_ppa_logo_cv_sim.stan")

model_prop <- cmdstan_model(
  "depot_1cmt_linear_ir3/Stan/Cross_Validation/depot_1cmt_prop_ir3_prop_logo_cv_sim.stan")

model_exp <- cmdstan_model(
  "depot_1cmt_linear_ir3/Stan/Cross_Validation/depot_1cmt_exp_ir3_exp_logo_cv_sim.stan")
