...
model <- cmdstan_model(
  "depot_1cmt_linear_ir3/Stan/Predict/depot_1cmt_prop_ir3_prop_predict_observed_subjects.stan")
...
## VPCs. Also see ../VPC/depot_1cmt_prop_ir3_prop_vpc.R for an alternate but 
...
## NPDEs. Also see ../NPDE/depot_1cmt_prop_ir3_prop_npde.R for an alternate but 
