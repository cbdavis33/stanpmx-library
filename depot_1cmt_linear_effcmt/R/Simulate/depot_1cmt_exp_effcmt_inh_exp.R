...
model <- cmdstan_model(
  "depot_1cmt_linear_effcmt/Stan/Simulate/depot_1cmt_exp_effcmt_inh_exp.stan") 
...
data %>%
  select(-IPRED) %>% 
  write_csv("depot_1cmt_linear_effcmt/Data/depot_1cmt_exp_effcmt_inh_exp.csv", na = ".")

params_ind %>%
  write_csv("depot_1cmt_linear_effcmt/Data/depot_1cmt_exp_effcmt_inh_exp_params_ind.csv")
