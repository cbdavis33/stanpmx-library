...
model <- cmdstan_model(
  "depot_1cmt_linear_effcmt/Stan/Predict/depot_1cmt_prop_effcmt_inh_prop_predict_new_subjects.stan")
...
data <- read_csv("depot_1cmt_linear_effcmt/Data/depot_1cmt_prop_effcmt_inh_prop.csv", 
                 na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
