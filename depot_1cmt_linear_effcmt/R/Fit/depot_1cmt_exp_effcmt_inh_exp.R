...
model <- cmdstan_model(
  "depot_1cmt_linear_effcmt/Stan/Fit/depot_1cmt_exp_effcmt_inh_exp.stan",
...
fit$save_object(
  "depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_exp_effcmt_inh_exp.rds")
fit$save_data_file(dir = "depot_1cmt_linear_effcmt/Stan/Fits/Stan_Data",
                   basename = "exp_exp_inh", timestamp = FALSE, 
                   random = FALSE)
