...
nonmem_data <- read_csv(
  "depot_1cmt_linear_effcmt/Data/depot_1cmt_prop_effcmt_inh_prop.csv",
  na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
stan_data <- list(n_subjects = n_subjects,
                  ...
                  scale_omega_e0 = 0.4,
                  scale_omega_ke0 = 0.4,
                  scale_omega_ec50 = 0.4,
                  lkj_df_omega_pd = 2,
                  scale_sigma_p_pd = 0.5,
                  prior_only = 0,
                  solver = 1) # 1 = mat-exp, 2 = General rk45, 3 = Coupled rk45, 4 = General bdf, 5 = Coupled bdf

model <- cmdstan_model(
  "depot_1cmt_linear_effcmt/Stan/Fit/depot_1cmt_prop_effcmt_inh_prop_all_solvers.stan",
  cpp_options = list(stan_threads = TRUE))


fit_matexp <- model$sample(
  data = stan_data,
  seed = 11235,
  chains = 4,
  parallel_chains = 4,
...
fit_matexp$save_object("depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop_matexp.rds")
...
fit_rk45$save_object("depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop_rk45.rds")
...
fit_rk45_coupled$save_object(
  "depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop_rk45_coupled.rds")
...
fit_bdf$save_object(
  "depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop_bdf.rds")
...
fit_bdf_coupled$save_object(
  "depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop_bdf_coupled.rds")
