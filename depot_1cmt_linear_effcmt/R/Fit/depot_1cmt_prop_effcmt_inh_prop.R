...
model <- cmdstan_model(
  "depot_1cmt_linear_effcmt/Stan/Fit/depot_1cmt_prop_effcmt_inh_prop.stan",
...
fit <- model$sample(
  ...
  refresh = 500,
  max_treedepth = 10,
  output_dir = "depot_1cmt_linear_effcmt/Stan/Fits/Output",
  output_basename = "prop_prop_inh",
...
fit$save_object(
  "depot_1cmt_linear_effcmt/Stan/Fits/depot_1cmt_prop_effcmt_inh_prop.rds")
fit$save_data_file(dir = "depot_1cmt_linear_effcmt/Stan/Fits/Stan_Data",
                   basename = "prop_prop_inh", timestamp = FALSE, 
                   random = FALSE)
